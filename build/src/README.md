...
4. **Curiosity in two movements** — two-column grid (`auto-fit, minmax(19rem, 1fr)`), hairline between. Each: op-art mark 84px (`mix-blend-mode: multiply`), h2 22px/600, 17px/1.8 body max-width 44ch.
   - "Curiosity connects" — `assets/opart/interdependence.png`; reveals and deepens connection with ourselves, each other, ideas and new futures.
   - "Stay curious" — `assets/opart/stillness.png`; staying curious keeps experience open, allowing what is important to reveal itself.
