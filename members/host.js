(() => {
  ...
  function localInvitationPreview(name, personalNote) {
    ...
    const noteMarkup = note
      ? '<tr><td style="padding:24px 48px 0 48px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" bgcolor="#F2ECFF" style="width:100%;background:#F2ECFF;border:1px solid #DED7EA;border-radius:14px;border-collapse:separate;overflow:hidden;"><tr><td style="padding:18px 20px 5px 20px;font-family:Helvetica,Arial,sans-serif;font-size:10px;font-weight:bold;letter-spacing:2px;text-transform:uppercase;color:#5A4B7C;">a note from John</td></tr><tr><td style="padding:5px 20px 20px 20px;font-family:Helvetica,Arial,sans-serif;font-size:16px;color:#312E29;line-height:25px;">'
        + `${escapeHtml(note).replace(/\r?\n/g, '<br>')}</td></tr></table></td></tr>`
      : '';
    return {
      subject: 'You’re invited to Beings Club',
      html: '<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><title>You’re invited to Beings Club</title></head><body style="margin:0;padding:0;background-color:#F7F5EF;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#F7F5EF;"><tr><td align="center" style="padding:36px 16px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="600" style="width:600px;max-width:600px;background-color:#FDFCF9;border-radius:20px;border-collapse:separate;overflow:hidden;"><tr><td align="left" style="padding:44px 48px 0 48px;"><img src="/assets/beings-logo-outline.png" alt="Beings Club — concentric hand-drawn rings" width="180" style="display:block;width:180px;max-width:100%;height:auto;border:0;"></td></tr><tr><td style="padding:28px 48px 0 48px;font-family:Helvetica,Arial,sans-serif;font-size:34px;font-weight:bold;letter-spacing:-1px;color:#171916;line-height:40px;">You’re invited to <span style="color:#5A4B7C">Beings Club</span>.</td></tr><tr><td style="padding:20px 48px 0 48px;font-family:Helvetica,Arial,sans-serif;font-size:16px;color:#4A473F;line-height:27px;"><p style="margin:0 0 16px">'
        + `${greeting}</p><p style="margin:0 0 16px">Membership is ongoing and freely offered.</p><p style="margin:0">The link below is your private entrance. It can be used once and expires in seven days.</p></td></tr>${noteMarkup}`
        + '<tr><td style="padding:30px 48px 0 48px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" style="border-radius:11px;border-collapse:separate;overflow:hidden;"><tr><td bgcolor="#171916" style="border-radius:11px;"><span style="display:block;padding:14px 32px;border-radius:11px;font-family:Helvetica,Arial,sans-serif;font-size:12px;font-weight:bold;letter-spacing:3px;text-transform:uppercase;color:#FFFFFF;">enter Beings Club</span></td></tr></table></td></tr><tr><td style="padding:12px 48px 0 48px;font-family:Helvetica,Arial,sans-serif;font-size:11px;color:#8A867D;line-height:18px;">This is a private link that logs you into your account, so please don’t share it.</td></tr><tr><td style="padding:36px 48px 44px 48px;"><table role="presentation" cellpadding="0" cellspacing="0" border="0" width="504" style="width:100%;border-top:1px solid #E7E4DB;"><tr><td style="padding:22px 0 0 0;font-family:\'Courier New\',Courier,monospace;font-size:11px;color:#A5A198;line-height:19px;">for the benefit of all beings</td></tr><tr><td style="padding:18px 0 0 0;font-family:Helvetica,Arial,sans-serif;font-size:11px;color:#A5A198;line-height:18px;">Beings Club · London, United Kingdom · <u>member entrance</u></td></tr></table></td></tr></table></td></tr></table></body></html>',
    };
  }
